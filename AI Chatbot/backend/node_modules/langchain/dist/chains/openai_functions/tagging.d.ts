...
import { InteropZodObject } from "@langchain/core/utils/types.js";
import { FunctionParameters } from "langchain/dist/output_parsers/openai_functions.js";
import { LLMChain, LLMChainInput } from "langchain/dist/chains/llm_chain.js";
/**
 ...
 */
export declare function createTaggingChain(schema: FunctionParameters, llm: BaseChatModel<BaseFunctionCallOptions>, options?: TaggingChainOptions): LLMChain<object, BaseChatModel<BaseFunctionCallOptions, import("@langchain/core/messages.js").AIMessageChunk>>;
/**
 ...
 * Will be removed in 0.2.0
 */
export declare function createTaggingChainFromZod(schema: InteropZodObject, llm: BaseChatModel<BaseFunctionCallOptions>, options?: TaggingChainOptions): LLMChain<object, BaseChatModel<BaseFunctionCallOptions, import("@langchain/core/messages.js").AIMessageChunk>>;

...
import { CallbackManagerForChainRun } from "@langchain/core/callbacks/manager.js";
import { BasePromptTemplate } from "@langchain/core/prompts.js";
import type { SerializedStuffDocumentsChain, SerializedMapReduceDocumentsChain, SerializedRefineDocumentsChain } from "langchain/dist/chains/serde.js";
import { BaseChain, ChainInputs } from "langchain/dist/chains/base.js";
...
export declare class RefineDocumentsChain extends BaseChain implements RefineDocumentsChainInput {
    ...
    documentPrompt: BasePromptTemplate<any, import("@langchain/core/prompt_values.js").BasePromptValueInterface, any>;
    get inputKeys(): string[];
    get outputKeys(): string[];
